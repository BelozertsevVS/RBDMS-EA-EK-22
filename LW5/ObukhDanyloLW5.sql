/* 1. Створити нову базу даних SHOP */ 

CREATE DATABASE SHOP 

/* 2. Створити таблицю в БД  SHOP для зберігання даних замовлень. Визначте найбільш оптимальні типи даних. */
/* Найменування таблиці SALES.
Таблиця містить наступні поля:
SALES_ORDER_ID -- Унікальний ідентифікатор замовлення - число без дробової частини - може бути більше ніж 2147483647
REVISION_NUMBER -- Інкремент для відстеження зміни за замовленням - число без дробової частини - не більше 255
ORDER_DATE -- Дата і час створення замовлення - дата і час
DUE_DATE -- Дата доставки замовлення - дата
SHIP_DATE -- Фактична дата доставки замовлення - дата
ONLINE_ORDER_FLAG -- 0 = Замовлення було створено менеджером. 1 = Замовлення було створено онлайн - число без дробової частини - не більше 1
CUSTOMER_ID -- Унікальний ідентифікатор клієнта, який здійснив замовлення - число без дробової частини - не більше 2147483647
SALES_PERSON_ID -- Унікальний ідентифікатор співробітника, який провів замовлення - число без дробової частини - не більше 2147483647
TERRITORY_ID -- Унікальний ідентифікатор території - число без дробової частини - не більше 2147483647
SUB_TOTAL -- Загальна сума замовлення - грошова величина - може бути більше ніж 214748.3647
TAX_AMT -- Загальна сума податків - грошова величина - не більше 214748.3647
FREIGHT -- Сума доставки - грошова величина - не більше 214748.3647
MODIFIED_DATE -- Дата і час останньої зміни рядка */ 
...
/* 3. Виконайте запит для внесення даних до створеної таблиці. */ 
...
/* 4. Відібрати з таблиці (отримати) всі дані */ 

SELECT *FROM SALES;

/* 5. Видалити таблицю SALES */ 
