...
--Додаємо дані у створену таблицю
...
--Аномалвя вставки: обмеження бази даних перешкоджають додаванню нових даних до таблиці, доки не буде створено новий відділ.
--Аномалія оновлення: оновлення даних в одному місці таблиці потребує множинних оновлень в інших місцях, щоб зберегти цілісність даних.
--Аномалія видалення: коли видалення даних призводить до втрати інших, потенційно важливих, даних.
