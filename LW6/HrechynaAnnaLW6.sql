...
-- Вводимо дані до Departments. Якщо DepartmentName не вказано, використати значення за замовчуванням

INSERT INTO Departments (DepartmentID) VALUES (1);

-- Застосовується DEFAULT значення 'General'
...
-- Вставитмо запис до Professors з існуючим Email, щоб перевірити UNIQUE обмеження
...
-- Видаляємо БД UniversityDB

DROP DATABASE UniversityDB;

-- Створюємо БД CompanyDB
...
-- Вводимо дані до Departments і Employees, створюємо призначення у Assignments
