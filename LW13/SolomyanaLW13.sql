...
Мета: Використовуючи таблицю `[dbo].[ORDERS]`, створіть SQL-запит, який агрегує загальну суму продажів по кожному виробнику за 2008 рік. Використайте функцію `SUM` для підрахунку загальної суми та `GROUP BY` для групування результатів за виробниками.
