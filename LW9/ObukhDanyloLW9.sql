...
FROM [dbo].[ORDERS]
WHERE [ORDER_DATE] NOT BETWEEN '2008-01-01' AND '2008-12-31' AND ([PRODUCT] LIKE '_A%' OR [PRODUCT] LIKE '%0%')
GROUP BY [MFR]
...
SELECT TOP 1 
WITH TIES [REP_OFFICE], COUNT (*) AS [EMPL_COUNT]
FROM [dbo].[SALESREPS]
WHERE [TITLE] IN ('Sales Rep') AND [AGE] IN (29, 45, 48) 
GROUP BY [REP_OFFICE]
